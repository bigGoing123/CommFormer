...
file_path = './csv/MMM2.csv'
data = pd.read_csv(file_path)

groups = {
 'LF-Commer': [
'commformer_MMM2_single_lf_seed3 - incre_win_rate',
 'commformer_MMM2_single_lf_seed2 - incre_win_rate',
 'commformer_MMM2_single_lf_seed1 - incre_win_rate',
 ],
 'MAPPO': [
 'mappo_MMM2_10v10_seed1 - incre_win_rate',
'mappo_MMM2_10v10_seed2 - incre_win_rate',
 'mappo_MMM2_10v10_seed3 - incre_win_rate',
],
 'HAPPO': [
 'happo_MMM2_10v10_seed1 - incre_win_rate',
 'happo_MMM2_10v10_seed3 - incre_win_rate',
]
}
...
# 保存图片到同一级目录
plt.savefig('./png/MMM2.png', dpi=300, bbox_inches='tight')
# plt.show() 