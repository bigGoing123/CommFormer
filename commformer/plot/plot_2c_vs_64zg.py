...
file_path = './csv/2c_vs_64zg.csv'
data = pd.read_csv(file_path)

groups = {
 'LF-Commer': [
'commformer_2c_vs_64zg_single_lf_seed1 - incre_win_rate',
 'commformer_2c_vs_64zg_single_lf_seed2 - incre_win_rate',
 ],
 'MAPPO': [
 'mappo_2c_vs_64zg_10v10_seed1 - incre_win_rate',
'mappo_2c_vs_64zg_10v10_seed2 - incre_win_rate',
 'mappo_2c_vs_64zg_10v10_seed3 - incre_win_rate',
],
 'HAPPO': [
 'happo_2c_vs_64zg_10v10_seed1 - incre_win_rate',
'happo_2c_vs_64zg_10v10_seed2 - incre_win_rate',
 'happo_2c_vs_64zg_10v10_seed3 - incre_win_rate',
]
}
...
# 保存图片到同一级目录
plt.savefig('./png/2c_vs_64zg.png', dpi=300, bbox_inches='tight')
# plt.show()