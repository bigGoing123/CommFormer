...
groups = {
 ...
 'commformer_MMM2_single_lf_seed1 - incre_win_rate',
  ...
  'LF-Commer-FC': [
'commformer_MMM2_FC - incre_win_rate__MIN',
 ]
}
...
lf_fc_data = df_long[df_long['Algorithm'] == 'LF-Commer-FC']
...
lf_stats['Algorithm'] = 'LF-Commer'
    ...
    # LF-Commer-FC取平均值
other_stats = (
    lf_fc_data.groupby(['Step', 'Algorithm'], as_index=False).agg(
...
# 保存图片到同一级目录
plt.savefig('./png/MMM2_ablation.png', dpi=300, bbox_inches='tight')
# plt.show() 