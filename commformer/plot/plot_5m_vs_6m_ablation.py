...
groups = {
 'LF-Commer-Max-1': [
'commformer_5m_vs_6m_single_lf_seed1 - incre_win_rate__MAX',
 ],
 'LF-Commer-Mean-2': [
 'commformer_5m_vs_6m_single_lf_seed2 - incre_win_rate__MAX',
 ],
 'LF-Commer-Min-3': [
'commformer_5m_vs_6m_single_lf_seed2 - incre_win_rate__MIN',
]
}
...
# 分别处理LF-Commer和其他算法
lf_data = df_long[df_long['Algorithm'] == 'LF-Commer-Max']
other_data = df_long[df_long['Algorithm'] != 'LF-Commer-Max']
...
lf_stats['Algorithm'] = 'LF-Commer-Max'
...
# 颜色自定义
palette = {
    'LF-Commer-Max': '#a0d3ff',
    'LF-Commer-Min': '#b39ddb', 
}
...
# 保存图片到同一级目录
plt.savefig('./png/5m_vs_6m_ablation.png', dpi=300, bbox_inches='tight')
# plt.show() 