...
file_path = './csv/3s5z.csv'
data = pd.read_csv(file_path)

groups = {
 'LF-Commer': [
'commformer_3s5z_single_lf_seed1 - incre_win_rate',
 'commformer_3s5z_single_lf_seed2 - incre_win_rate',
 'commformer_3s5z_single_lf_seed3 - incre_win_rate',
 ],
 'MAPPO': [
 'mappo_3s5z_10v10_seed1 - incre_win_rate',
'mappo_3s5z_10v10_seed2 - incre_win_rate',
 'mappo_3s5z_10v10_seed3 - incre_win_rate',
],
 'HAPPO': [
 'happo_3s5z_10v10_seed1 - incre_win_rate',
'happo_3s5z_10v10_seed2 - incre_win_rate',
 'happo_3s5z_10v10_seed3 - incre_win_rate',
]
}
...
# 保存图片到同一级目录
plt.savefig('./png/3s5z.png', dpi=300, bbox_inches='tight')
# plt.show()