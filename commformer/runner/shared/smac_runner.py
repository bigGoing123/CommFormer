...
class SMACRunner(Runner):
    ...
    def interactive_play(self, model_path):
        from commformer.scripts.test.human_play import HumanVsMAT
        interactive_env = HumanVsMAT(
            config=self.all_args,
            model_path=model_path,
            map_name=self.all_args.map_name
        )
        interactive_env.run()
